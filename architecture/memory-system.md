...
AuroraBot 的记忆是三级联合结构：`UnifiedMemoryManager` 封装了 L1/L2/L3 的写入与检索接口，认知节点通过它存取记忆。
...
- 想了解记忆在认知管路中的位置：读 [认知架构](./brain-architecture.html)
- 想了解代码结构：读 [架构总览](./system-overview.html)
